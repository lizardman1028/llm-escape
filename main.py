...
def main():
    ...
    items = {
        ...
        "door": Item("door", "A locked door. Maybe it leads somewhere.", unlock_type=Unlock_Type.str, unlock_combination="1234", examine_reveals=[], pygame_object=pygame_door, item_type=Item_Type.ITEM)}
