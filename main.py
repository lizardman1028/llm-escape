...
def main():
    ...
    items = {
        ...
        "door": Item("door", "A locked door. Maybe it leads somewhere.", unlock_type=Unlock_Type.int, unlock_combination="1234", examine_reveals=[], unlock_reveals=["room2"], pygame_object=pygame_door, item_type=Item_Type.ITEM),
        "room2":Item("room2", "You see a new door and two pieces of paper on the ground along with another locked door", pygame_object=pygame_room2, item_type=Item_Type.ROOM, examine_reveals=["paper1", "paper2", "door2"]),
    ...
    # TTTFTTF
    agent_llm.llm_config(show_last_action=True, 
                         header_for_new_state=True, 
                         remember_only_action=True, 
                         remember_only_post_think=False, 
                         initial_prompt_multiplayer=True, 
                         remember_only_valid=True, 
                         api_funcs_only=False)
    agent_llm2.llm_config(show_last_action=True, 
                         header_for_new_state=True, 
                         remember_only_action=True, 
                         remember_only_post_think=False, 
                         initial_prompt_multiplayer=True, 
